...
def deepnn(x, phase_train):
    ...
    x, y = h_1.get_shape()
    h_j_1 = tf.Variable(tf.ones([100*32*32]))
    ...
    x, y = h_2.get_shape()
    h_j_2 = tf.Variable(tf.ones([100*32*32]))
    ...
    x, y = h_3.get_shape()
    h_j_3 = tf.Variable(tf.ones([100*32*32]))
    ...
    x, y = h_4.get_shape()
    h_j_4 = tf.Variable(tf.ones([100*32*32]))
    ...
    x, y = h_5.get_shape()
    h_j_5 = tf.Variable(tf.ones([100*32*32]))
    ...
    x, y = h_6.get_shape()
    h_j_6 = tf.Variable(tf.ones([100*32*32]))
    ...
    x, y = h_7.get_shape()
    h_j_7 = tf.Variable(tf.ones([100*32*32]))
