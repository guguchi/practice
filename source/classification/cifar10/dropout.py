...
tf.app.flags.DEFINE_string('save_data_path', './../../../data/classification/cifar10/dropout/0702/', "データ保存先")
        ...
        with tf.Session(config=config) as sess:
            ...
            for i in range(FLAGS.step):
                ...
                _, cross_entropy_curr, train_accuracy = sess.run(
                    ...
                    feed_dict={x: _train_images, y_: _trains_labels, keep_prob: FLAGS.drop_ratio})
