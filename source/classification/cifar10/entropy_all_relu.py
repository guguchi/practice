...
tf.app.flags.DEFINE_float('lam', 1.0, "正則化")
...
tf.app.flags.DEFINE_float('gpu_memory', 0.3, "gpuメモリ使用割合")
tf.app.flags.DEFINE_integer('test_example', 10000, "テストデータ数")
tf.app.flags.DEFINE_string('cifar_data_dir', './../../../data/', "cifar10保存先")
tf.app.flags.DEFINE_string('save_data_path', './../../../data/classification/cifar10/entropy_all_relu/0704/', "データ保存先")
