...
for layer_size in layer_size_list:
    path = '/home/ishii/Desktop/research/practice/data/classification/cifar10/layer_change/{}_layer_{}_batch_{}_alpha_{}/'.format(activation, layer_size, batch, alpha)
...
plt.legend()
plt.tight_layout()
#plt.savefig('{}_negative_entropy_batch_{}_alpha_{}.png'.format(activation, batch, alpha))
...
plt.legend()
plt.savefig('cifar10_{}_negative_entropy_batch_{}_alpha_{}.png'.format(activation, batch, alpha))
plt.show()
