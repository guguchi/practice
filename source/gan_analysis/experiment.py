...
step = 2000
learning_rate_D_list = [0.0001]#[0.0001, 0.00005, 0.00001]
learning_rate_G_list = [0.0001]#[0.0001, 0.00005, 0.00001]
num_cluster_list = [8]#[8, 4, 2, 1]
scale = 2
std_list = [0.2]#[0.5, 0.4, 0.3, 0.2, 0.1]
z_size_list = [30]#[100, 50, 10, 2, 1]#[500, 100, 50, 10, 2, 1]#,50 10
date = '20170329/'
concept = 'z_zize/'
