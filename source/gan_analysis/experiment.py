...
step = 1000000
learning_rate_D_list = [0.0005, 0.0004, 0.0003, 0.0002, 0.0001, 0.00009, 0.00008, 0.00007, 0.00006, 0.00005]
learning_rate_G_list = [0.0005, 0.0004, 0.0003, 0.0002, 0.0001, 0.00009, 0.00008, 0.00007, 0.00006, 0.00005]
...
scale = 2
std_list = [0.2]#[0.5, 0.4, 0.3, 0.2, 0.1]
z_size_list = [50]#[500, 100, 50, 10, 2, 1]#,50 10
date = '20170327/'
concept = 'num_cluster/'
save_root = '/home/yamaguchi-s/Desktop/Research/practice/data/gan_analysis/'+date+concept
